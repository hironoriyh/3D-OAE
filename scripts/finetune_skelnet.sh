...
# GPUS=$1
# PY_ARGS=${@:2}
ckpts=/home/hyoshida/git/3D-OAE/experiments/Transformer_pcn_trainskel/PCN_models/skelnet_bs16/ckpt-last.pth
#ckpts=/home/hyoshida/git/3D-OAE/experiments/Transformer_pcn/PCN_models/downloaded/pcd_completion.pth
